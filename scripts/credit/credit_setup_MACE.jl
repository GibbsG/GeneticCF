...
root = "/Users/gzx/Desktop/research/geco/GeCo.jl"
path = "/data/credit/"
data = CSV.File(root*path*"/credit_processed.csv") |> DataFrame
...
# classifier = pickle.load(pybuiltin("open")(root*"scripts/mace_models/credit_model.pickle","rb"))
classifier = pickle.load(pybuiltin("open")("/Users/gzx/Desktop/research/geco/GeCo.jl/scripts/mace_models/credit_model.pickle","rb"))
